...
A: In line 9 of cache.py file, there is a function called get_movie, if you want to change the api key to yours, you can substitute default parameter key with you own api key.

2. How to run the program?
A: Just run the final_project.py.
